from app.schemas.domain import DetectionResponse
...
def detect_incident(frame_reference: str) -> DetectionResponse:
    ...
    if "blocked" in lowered or "roadblock" in lowered:
        return DetectionResponse(label="road_blockage", confidence=0.88, severity="medium")
